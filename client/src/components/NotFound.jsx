            ...
            <div className="flex flex-wrap items-center ">
                <div className="w-full px-2 lg:px-4 lg:w-2/4 lg:mb-0 lg:py-0 py-7">
                    <div className="text-center lg:text-left">
                        <h1
                            className="inline-block mb-8 font-semibold text-gray-800 text-7xl lg:text-9xl dark:text-gray-400">
                            Oops!</h1>
                        <h2 className="mb-8 text-2xl font-semibold text-gray-700 lg:text-4xl dark:text-gray-400">404
                            Page not found</h2>
                        ...
                        <div className="flex flex-wrap items-center justify-start">
                            <a href="/"
                                className="w-full px-8 py-4 mb-8 mr-0 text-base font-medium text-gray-100 uppercase rounded-full lg:w-auto lg:mb-0 lg:mr-4 md:w-full p-4  hover:opacity-80 bg-secondary">
                                Return Home
                            </a>
                ...
                <div className="hidden w-full mb-12 lg:block lg:w-2/4 lg:mb-0">
                    <img src="https://i.postimg.cc/dt0HXw8J/pexels-mikhail-nilov-7534104.jpg" alt=""
